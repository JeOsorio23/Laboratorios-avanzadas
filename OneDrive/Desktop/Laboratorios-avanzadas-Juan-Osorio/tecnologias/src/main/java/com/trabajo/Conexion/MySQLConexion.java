...
public class MySQLConexion implements Conexion{
    ...
    public MySQLConexion(){
        try{
            ...
            this.connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/cursos_inscritos", "root", "1234");
            inicializarTablas();
        } catch(Exception e){
            e.printStackTrace();
        }
    ...
    private void inicializarTablas() {
        try (Statement statement = connection.createStatement()) {
            ...
            statement.execute("INSERT IGNORE INTO estudiante (id, nombre, apellidos, email, codigo, programa_id, activo, promedio) VALUES" +
